...
```
https://localhost:8888/keys/hls.key   ← 密钥 URI（客户端从此 URL 下载密钥）
...
#EXT-X-KEY:METHOD=AES-128,URI="https://localhost:8888/keys/hls.key",IV=0x0123456789abcdef...
#EXTINF:4.000000,
segment_0001.ts
#EXTINF:4.000000,
segment_0002.ts
...
const hls = new Hls();
hls.loadSource('https://localhost:8888/hls/encrypted/ts/index.m3u8');
...
<script>
  const player = videojs('player', {
    sources: [{ src: 'https://localhost:8888/hls/encrypted/ts/index.m3u8', type: 'application/vnd.apple.mpegurl' }]
  });
</script>
```
